...
GLuint createShaderProgram(int shaderType, const GLchar** shaderStr)
{
...
int _main(int argc, char** argv)
{
	...
	//创建shader
	auto vertexShader = createShaderProgram(GL_VERTEX_SHADER, &vertexShaderSource);
	auto fragmentShader = createShaderProgram(GL_FRAGMENT_SHADER, &fragmentShaderSource);

	//链接两个着色器成为shaderProgram
